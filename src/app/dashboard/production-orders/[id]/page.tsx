      ...
      <header className="h-20 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-8 sticky top-0 z-10">
        <div className="flex flex-col">
          <div className="flex items-center gap-2 text-xs text-slate-500 mb-1">
            ...
            <Link href="/dashboard/production-orders" className="hover:text-primary transition-colors">Üretim Emirleri</Link>
            <span className="material-symbols-outlined text-[10px]">chevron_right</span>
            <span className="text-slate-900 dark:text-slate-200 font-medium">#ORD-2024-001</span>
          </div>
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-bold text-navy-text dark:text-white">
              Üretim Emri: Endüstriyel Motor - V2
            </h1>
            <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-amber-100 text-amber-700 border border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800/50 flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 text-sm font-medium rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
            <span className="material-symbols-outlined text-lg">edit</span>
            Düzenle
          </button>
          <button className="flex items-center gap-2 px-4 py-2 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary-dark shadow-sm shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]">
